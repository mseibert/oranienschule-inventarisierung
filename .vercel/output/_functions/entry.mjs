...
import { manifest } from './manifest_DGuILHPQ.mjs';
...
const _page5 = () => import('./pages/test.json.astro.mjs');
...
const _args = {
    "middlewareSecret": "4117ce31-d815-4a72-afac-2c77341831f0",
